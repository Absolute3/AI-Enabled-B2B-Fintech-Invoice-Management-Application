...
public class Pojo {
	...
	public Pojo(int sl_no, String business_code, int cust_number, Date clear_date, int buisness_year, String doc_id,
			...
			double total_open_amount, Date baseline_create_date, String cust_payment_terms, int invoice_id,
			String aging_bucket, String name_customer) {
		super();
		this.sl_no = sl_no;
	...
	public void setClear_date(Date string) {
		this.clear_date = string;
	}
