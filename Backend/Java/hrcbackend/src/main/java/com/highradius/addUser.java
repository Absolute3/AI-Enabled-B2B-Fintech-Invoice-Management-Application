...
//			//Date baseline_create_date = (Date) f1.parse(baseline_create_date_str);
////			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
////			Date baseline_create_date = sdf.parse(baseline_create_date_str);
//			//Date baseline_create_date = request.getParameter("baseline_create_date");
...
//			String invoice_currency = request.getParameter("invoice_currency");
			...
			try {
				...
				{
					ps.setFloat(12,Float.parseFloat(total_open_amount));
				}
